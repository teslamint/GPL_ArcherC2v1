...
#ifdef CMD_SAVEENV
/*
**	Now we didn't use flash_addr, hide it.
@@	By TengFei, 13/01/25
*/
#if 0
...
int spi_env_init(void)
{
	...
	/*
	**	If ENV_IS_EMBEDDED was defined, we didn't malloc env_ptr space.
	@@	By TengFei, 13/01/25
	*/
...
{
	/*
	**	If ENV_IS_EMBEDDED was defined, we disable save_env feature.
	@@	By TengFei, 13/01/25
	*/
#if !defined(ENV_IS_EMBEDDED)
