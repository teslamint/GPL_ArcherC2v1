/*
  ...
  $Header: //WIFI_SOC/release/SDK_4_1_0_0/source/linux-2.6.36.x/drivers/scsi/osst.c#1 $
...
static const char * cvsid = "$Id: //WIFI_SOC/release/SDK_4_1_0_0/source/linux-2.6.36.x/drivers/scsi/osst.c#1 $";
