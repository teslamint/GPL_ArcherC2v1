.set workspace_name sshpkcs
.set guid_t-p12 DBDAF417-493D-3602-9700-AE628013B8C7
.set file_t-p12 tests\\t-p12.vcproj
...
.set file_t-pkcs1 tests\\t-pkcs1.vcproj
...
.set file_t-pkcs8 tests\\t-pkcs8.vcproj
...
.set file_t-p7dump tests\\t-p7dump.vcproj
...
.set file_t-p12make tests\\t-p12make.vcproj
...
.set file_sshpkcs sshpkcs.vcproj
