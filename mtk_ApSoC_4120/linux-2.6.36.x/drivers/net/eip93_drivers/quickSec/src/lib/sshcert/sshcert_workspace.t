.set workspace_name sshcert
.set guid_t-makeandverify 937AC967-0E89-3479-8000-41383A4C07AC
.set file_t-makeandverify tests\\t-makeandverify.vcproj
...
.set file_t-certhierarchy tests\\t-certhierarchy.vcproj
...
.set file_pem2bin tests\\pem2bin.vcproj
...
.set file_t-certtest tests\\t-certtest.vcproj
...
.set file_t-ocsp tests\\t-ocsp.vcproj
...
.set file_t-ocsp-packet tests\\t-ocsp-packet.vcproj
...
.set file_sshcert sshcert.vcproj
