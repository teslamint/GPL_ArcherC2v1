.set workspace_name sshtls
.set guid_t-tls F11EC4EA-0C41-3DBA-9000-2B36FCEA9850
.set file_t-tls tests\\t-tls.vcproj
...
.set file_tls-client tests\\tls-client.vcproj
...
.set file_t-speedtest tests\\t-speedtest.vcproj
