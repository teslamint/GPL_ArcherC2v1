.set project_name t-eventloop
.set project_type console
.set project_platforms
.set project_guid 4CBC4FCB-0D0A-353F-9400-0C1C521BCE93
.set project_dir lib\\sshutil\\tests
...
.set srcs \
	eventloop_perf.c \
	t-eventloop.c
.set dir_eventloop_perf.c lib\\sshutil\\tests 
.set dir_t-eventloop.c lib\\sshutil\\tests 
.set custom_tags
.set rsrcs
.set hdrs
