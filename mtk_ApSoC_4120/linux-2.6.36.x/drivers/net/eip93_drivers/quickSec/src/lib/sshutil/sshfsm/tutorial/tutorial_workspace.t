.set workspace_name tutorial
.set guid_hello 5D41402A-BC4B-3A76-9900-9D911017C592
.set file_hello hello.vcproj
...
.set file_producer-consumer producer-consumer.vcproj
...
.set file_timeout timeout.vcproj
