.set workspace_name sshvalidator
.set guid_t-basic 927A3472-A4AD-3B59-8800-C5CC1E819FF9
.set file_t-basic tests\\t-basic.vcproj
...
.set file_t-anchor tests\\t-anchor.vcproj
...
.set file_t-cmi tests\\t-cmi.vcproj
...
.set file_t-cmistress tests\\t-cmistress.vcproj
...
.set file_t-certbundle tests\\t-certbundle.vcproj
...
.set file_sshvalidator sshvalidator.vcproj
