.set workspace_name sshmath
.set guid_factor 742F32C6-5FFD-38B7-8600-307F8DE2D47D
.set file_factor tests\\factor.vcproj
...
.set file_t-xuint tests\\t-xuint.vcproj
...
.set file_t-xuint2 tests\\t-xuint2.vcproj
...
.set file_t-mathtest tests\\t-mathtest.vcproj
...
.set file_t-sophie-germain tests\\t-sophie-germain.vcproj
...
.set file_t-montgomery tests\\t-montgomery.vcproj
...
.set file_t-mathspeed tests\\t-mathspeed.vcproj
...
.set file_sshmath sshmath.vcproj
