...
/*
  ...
  Windows NT computer "c:\\test\\zlib109.zip" or on an Unix computer
  "zlib/zlib109.zip".  If the zipfile cannot be opened (file don't exist
...
/*
  ...
  .Zip opened with unzipOpenCurrentFile (see later), these files MUST be
