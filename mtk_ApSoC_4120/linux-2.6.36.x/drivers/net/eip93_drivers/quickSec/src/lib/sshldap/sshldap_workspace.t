.set workspace_name sshldap
.set guid_t-ldap 0850ACF5-E8DB-39EB-8C00-F27BB7709088
.set file_t-ldap tests\\t-ldap.vcproj
...
.set file_t-ldapconv tests\\t-ldapconv.vcproj
...
.set file_t-ldapfilter tests\\t-ldapfilter.vcproj
...
.set file_sshldap sshldap.vcproj
