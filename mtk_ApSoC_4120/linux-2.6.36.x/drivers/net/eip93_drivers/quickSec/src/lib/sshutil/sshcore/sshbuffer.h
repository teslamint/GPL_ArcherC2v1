...
append data and consume it from either end. Routines with the 
ssh_xbuffer prefix will call ssh_fatal (thus not returning) if they 
fail to obtain memory.

<keywords variable-size buffers, buffer/variable-size, ssh_xbuffer, 
utility functions/buffers>
