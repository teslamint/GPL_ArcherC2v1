.set workspace_name sshexternalkey
.set guid_t-softprovider 20508522-4DC2-3C38-8400-64514B23A5D8
.set file_t-softprovider tests\\t-softprovider.vcproj
...
.set file_t-genacc tests\\t-genacc.vcproj
...
.set file_t-genacc-speed tests\\t-genacc-speed.vcproj
...
.set file_t-genacc_rsacrt tests\\t-genacc_rsacrt.vcproj
...
.set file_t-externalkey tests\\t-externalkey.vcproj
...
.set file_t-simple_externalkey tests\\t-simple_externalkey.vcproj
...
.set file_t-accelerator tests\\t-accelerator.vcproj
...
.set file_t-makereq tests\\t-makereq.vcproj
...
.set file_t-externalcert tests\\t-externalcert.vcproj
...
.set file_sshexternalkey sshexternalkey.vcproj
