/*
  ...
  Implementation of AES candidate algorithm RIJNDAEL by Joan Daemen
  <daemen.j@protonworld.com> and Vincent Rijmen
  <vincent.rijmen@esat.kuleuven.ac.be>.  Key setup and inner loop
  implementation of this cipher is loosely based on the implementation
  by Brian Gladman <gladman@seven77.demon.co.uk>.
...
#define SSH_DEBUG_MODULE "SshCipherRijndael"
...
static const SshUInt32 ssh_rij_rco_tab[10] = {
...
#if SSH_DATA_CACHE_SIZE >= 32

#define SSH_RIJ_FT_TAB0(byte)  (ssh_rij_ft_tab[0][byte])
#define SSH_RIJ_FT_TAB1(byte)  (ssh_rij_ft_tab[1][byte])
#define SSH_RIJ_FT_TAB2(byte)  (ssh_rij_ft_tab[2][byte])
#define SSH_RIJ_FT_TAB3(byte)  (ssh_rij_ft_tab[3][byte])

static const SshUInt32 ssh_rij_ft_tab[4][256] =
{
  {
...
#define SSH_RIJ_IT_TAB0(byte)  (ssh_rij_it_tab[0][byte])
#define SSH_RIJ_IT_TAB1(byte)  (ssh_rij_it_tab[1][byte])
#define SSH_RIJ_IT_TAB2(byte)  (ssh_rij_it_tab[2][byte])
#define SSH_RIJ_IT_TAB3(byte)  (ssh_rij_it_tab[3][byte])

static const SshUInt32 ssh_rij_it_tab[4][256] =
{
  {
...
#else
/* Here's the case for smaller data caches when
   SSH_DATA_CACHE_SIZE < 32. */

#define SSH_RIJ_FT_TAB0(byte)  (ssh_rij_ft_tab[byte])
#define SSH_RIJ_FT_TAB1(byte)  SSH_ROR32_CONST(ssh_rij_ft_tab[byte], 24)
#define SSH_RIJ_FT_TAB2(byte)  SSH_ROR32_CONST(ssh_rij_ft_tab[byte], 16)
#define SSH_RIJ_FT_TAB3(byte)  SSH_ROR32_CONST(ssh_rij_ft_tab[byte], 8)

static const SshUInt32 ssh_rij_ft_tab[256] =
{
  0xa56363c6, 0x847c7cf8, 0x997777ee, 0x8d7b7bf6,
  0x0df2f2ff, 0xbd6b6bd6, 0xb16f6fde, 0x54c5c591,
  0x50303060, 0x03010102, 0xa96767ce, 0x7d2b2b56,
...
#define SSH_RIJ_IT_TAB0(byte)  (ssh_rij_it_tab[byte])
#define SSH_RIJ_IT_TAB1(byte)  SSH_ROR32_CONST(ssh_rij_it_tab[byte], 24)
#define SSH_RIJ_IT_TAB2(byte)  SSH_ROR32_CONST(ssh_rij_it_tab[byte], 16)
#define SSH_RIJ_IT_TAB3(byte)  SSH_ROR32_CONST(ssh_rij_it_tab[byte], 8)

static const SshUInt32 ssh_rij_it_tab[256] =
{
  0x50a7f451, 0x5365417e, 0xc3a4171a, 0x965e273a,
  0xcb6bab3b, 0xf1459d1f, 0xab58faac, 0x9303e34b,
  0x55fa3020, 0xf66d76ad, 0x9176cc88, 0x254c02f5,
...
#endif /* SSH_DATA_CACHE_SIZE < 32 */


#if SSH_DATA_CACHE_SIZE >= 128

#define SSH_RIJ_FL_TAB0(byte)  ssh_rij_fl_tab[0][byte]
#define SSH_RIJ_FL_TAB1(byte)  ssh_rij_fl_tab[1][byte]
#define SSH_RIJ_FL_TAB2(byte)  ssh_rij_fl_tab[2][byte]
#define SSH_RIJ_FL_TAB3(byte)  ssh_rij_fl_tab[3][byte]

static const SshUInt32 ssh_rij_fl_tab[4][256] =
{
  {
...
#define SSH_RIJ_IL_TAB0(byte)  (ssh_rij_il_tab[0][byte])
#define SSH_RIJ_IL_TAB1(byte)  (ssh_rij_il_tab[1][byte])
#define SSH_RIJ_IL_TAB2(byte)  (ssh_rij_il_tab[2][byte])
#define SSH_RIJ_IL_TAB3(byte)  (ssh_rij_il_tab[3][byte])

static const SshUInt32 ssh_rij_il_tab[4][256] =
{
  {
...
/* The code for SSH_DATA_CACHE_SIZE < 128 */

#define SSH_RIJ_FL_TAB0(byte)  ((SshUInt32) ssh_rij_fl_tab[byte])
#define SSH_RIJ_FL_TAB1(byte)  (((SshUInt32) ssh_rij_fl_tab[byte]) << 8)
#define SSH_RIJ_FL_TAB2(byte)  (((SshUInt32) ssh_rij_fl_tab[byte]) << 16)
#define SSH_RIJ_FL_TAB3(byte)  (((SshUInt32) ssh_rij_fl_tab[byte]) << 24)

static const SshUInt8 ssh_rij_fl_tab[256] =
{
...
#define SSH_RIJ_IL_TAB0(byte)  ((SshUInt32) ssh_rij_il_tab[byte])
#define SSH_RIJ_IL_TAB1(byte)  (((SshUInt32) ssh_rij_il_tab[byte]) << 8)
#define SSH_RIJ_IL_TAB2(byte)  (((SshUInt32) ssh_rij_il_tab[byte]) << 16)
#define SSH_RIJ_IL_TAB3(byte)  (((SshUInt32) ssh_rij_il_tab[byte]) << 24)

static const SshUInt32 ssh_rij_il_tab[256] =
{
...
#endif  /* SSH_DATA_CACHE_SIZE < 128 */


#define SSH_RIJ_BYTE0(x)  (((SshUInt32) (x)) & 0xFF)
#define SSH_RIJ_BYTE1(x)  ((((SshUInt32) (x)) >> 8) & 0xFF)
#define SSH_RIJ_BYTE2(x)  ((((SshUInt32) (x)) >> 16) & 0xFF)
#define SSH_RIJ_BYTE3(x)  (((SshUInt32) (x)) >> 24)


/* SSH_RIJ_F_NROUND and SSH_RIJ_F_LROUND are used during encryption,
   the latter one performs the last round.

   Note that these macros don't use `do {'...`} while (0)' embracings,
   because they were noticed to limit some compilers' (including
   gcc's) capabilities of instruction scheduling. */

#define SSH_RIJ_F_NROUND(bo, bi, k)                     \
  {                                                     \
    bo ## _0                                            \
      = SSH_RIJ_FT_TAB0(SSH_RIJ_BYTE0(bi ## _0))        \
      ^ SSH_RIJ_FT_TAB1(SSH_RIJ_BYTE1(bi ## _1))        \
      ^ SSH_RIJ_FT_TAB2(SSH_RIJ_BYTE2(bi ## _2))        \
      ^ SSH_RIJ_FT_TAB3(SSH_RIJ_BYTE3(bi ## _3))        \
      ^ k[0];                                           \
    bo ## _1                                            \
      = SSH_RIJ_FT_TAB0(SSH_RIJ_BYTE0(bi ## _1))        \
      ^ SSH_RIJ_FT_TAB1(SSH_RIJ_BYTE1(bi ## _2))        \
      ^ SSH_RIJ_FT_TAB2(SSH_RIJ_BYTE2(bi ## _3))        \
      ^ SSH_RIJ_FT_TAB3(SSH_RIJ_BYTE3(bi ## _0))        \
      ^ k[1];                                           \
    bo ## _2                                            \
      = SSH_RIJ_FT_TAB0(SSH_RIJ_BYTE0(bi ## _2))        \
      ^ SSH_RIJ_FT_TAB1(SSH_RIJ_BYTE1(bi ## _3))        \
      ^ SSH_RIJ_FT_TAB2(SSH_RIJ_BYTE2(bi ## _0))        \
      ^ SSH_RIJ_FT_TAB3(SSH_RIJ_BYTE3(bi ## _1))        \
      ^ k[2];                                           \
    bo ## _3                                            \
      = SSH_RIJ_FT_TAB0(SSH_RIJ_BYTE0(bi ## _3))        \
      ^ SSH_RIJ_FT_TAB1(SSH_RIJ_BYTE1(bi ## _0))        \
      ^ SSH_RIJ_FT_TAB2(SSH_RIJ_BYTE2(bi ## _1))        \
      ^ SSH_RIJ_FT_TAB3(SSH_RIJ_BYTE3(bi ## _2))        \
      ^ k[3];                                           \
    k += 4;                                             \
  }

#define SSH_RIJ_F_LROUND(bo, bi, k)                     \
  {                                                     \
    bo ## _0                                            \
      = SSH_RIJ_FL_TAB0(SSH_RIJ_BYTE0(bi ## _0))        \
      ^ SSH_RIJ_FL_TAB1(SSH_RIJ_BYTE1(bi ## _1))        \
      ^ SSH_RIJ_FL_TAB2(SSH_RIJ_BYTE2(bi ## _2))        \
      ^ SSH_RIJ_FL_TAB3(SSH_RIJ_BYTE3(bi ## _3))        \
      ^ k[0];                                           \
    bo ## _1                                            \
      = SSH_RIJ_FL_TAB0(SSH_RIJ_BYTE0(bi ## _1))        \
      ^ SSH_RIJ_FL_TAB1(SSH_RIJ_BYTE1(bi ## _2))        \
      ^ SSH_RIJ_FL_TAB2(SSH_RIJ_BYTE2(bi ## _3))        \
      ^ SSH_RIJ_FL_TAB3(SSH_RIJ_BYTE3(bi ## _0))        \
      ^ k[1];                                           \
    bo ## _2                                            \
      = SSH_RIJ_FL_TAB0(SSH_RIJ_BYTE0(bi ## _2))        \
      ^ SSH_RIJ_FL_TAB1(SSH_RIJ_BYTE1(bi ## _3))        \
      ^ SSH_RIJ_FL_TAB2(SSH_RIJ_BYTE2(bi ## _0))        \
      ^ SSH_RIJ_FL_TAB3(SSH_RIJ_BYTE3(bi ## _1))        \
      ^ k[2];                                           \
    bo ## _3                                            \
      = SSH_RIJ_FL_TAB0(SSH_RIJ_BYTE0(bi ## _3))        \
      ^ SSH_RIJ_FL_TAB1(SSH_RIJ_BYTE1(bi ## _0))        \
      ^ SSH_RIJ_FL_TAB2(SSH_RIJ_BYTE2(bi ## _1))        \
      ^ SSH_RIJ_FL_TAB3(SSH_RIJ_BYTE3(bi ## _2))        \
      ^ k[3];                                           \
  }

/* SSH_RIJ_I_NROUND and SSH_RIJ_I_LROUND are used during decryption,
   the latter one performs the last round. */

#define SSH_RIJ_I_NROUND(bo, bi, k)                     \
  {                                                     \
    bo ## _0                                            \
      = SSH_RIJ_IT_TAB0(SSH_RIJ_BYTE0(bi ## _0))        \
      ^ SSH_RIJ_IT_TAB1(SSH_RIJ_BYTE1(bi ## _3))        \
      ^ SSH_RIJ_IT_TAB2(SSH_RIJ_BYTE2(bi ## _2))        \
      ^ SSH_RIJ_IT_TAB3(SSH_RIJ_BYTE3(bi ## _1))        \
      ^ k[0];                                           \
    bo ## _1                                            \
      = SSH_RIJ_IT_TAB0(SSH_RIJ_BYTE0(bi ## _1))        \
      ^ SSH_RIJ_IT_TAB1(SSH_RIJ_BYTE1(bi ## _0))        \
      ^ SSH_RIJ_IT_TAB2(SSH_RIJ_BYTE2(bi ## _3))        \
      ^ SSH_RIJ_IT_TAB3(SSH_RIJ_BYTE3(bi ## _2))        \
      ^ k[1];                                           \
    bo ## _2                                            \
      = SSH_RIJ_IT_TAB0(SSH_RIJ_BYTE0(bi ## _2))        \
      ^ SSH_RIJ_IT_TAB1(SSH_RIJ_BYTE1(bi ## _1))        \
      ^ SSH_RIJ_IT_TAB2(SSH_RIJ_BYTE2(bi ## _0))        \
      ^ SSH_RIJ_IT_TAB3(SSH_RIJ_BYTE3(bi ## _3))        \
      ^ k[2];                                           \
    bo ## _3                                            \
      = SSH_RIJ_IT_TAB0(SSH_RIJ_BYTE0(bi ## _3))        \
      ^ SSH_RIJ_IT_TAB1(SSH_RIJ_BYTE1(bi ## _2))        \
      ^ SSH_RIJ_IT_TAB2(SSH_RIJ_BYTE2(bi ## _1))        \
      ^ SSH_RIJ_IT_TAB3(SSH_RIJ_BYTE3(bi ## _0))        \
      ^ k[3];                                           \
    k -= 4;                                             \
  }

#define SSH_RIJ_I_LROUND(bo, bi, k)                     \
  {                                                     \
    bo ## _0                                            \
      = SSH_RIJ_IL_TAB0(SSH_RIJ_BYTE0(bi ## _0))        \
      ^ SSH_RIJ_IL_TAB1(SSH_RIJ_BYTE1(bi ## _3))        \
      ^ SSH_RIJ_IL_TAB2(SSH_RIJ_BYTE2(bi ## _2))        \
      ^ SSH_RIJ_IL_TAB3(SSH_RIJ_BYTE3(bi ## _1))        \
      ^ k[0];                                           \
    bo ## _1                                            \
      = SSH_RIJ_IL_TAB0(SSH_RIJ_BYTE0(bi ## _1))        \
      ^ SSH_RIJ_IL_TAB1(SSH_RIJ_BYTE1(bi ## _0))        \
      ^ SSH_RIJ_IL_TAB2(SSH_RIJ_BYTE2(bi ## _3))        \
      ^ SSH_RIJ_IL_TAB3(SSH_RIJ_BYTE3(bi ## _2))        \
      ^ k[1];                                           \
    bo ## _2                                            \
      = SSH_RIJ_IL_TAB0(SSH_RIJ_BYTE0(bi ## _2))        \
      ^ SSH_RIJ_IL_TAB1(SSH_RIJ_BYTE1(bi ## _1))        \
      ^ SSH_RIJ_IL_TAB2(SSH_RIJ_BYTE2(bi ## _0))        \
      ^ SSH_RIJ_IL_TAB3(SSH_RIJ_BYTE3(bi ## _3))        \
      ^ k[2];                                           \
    bo ## _3                                            \
      = SSH_RIJ_IL_TAB0(SSH_RIJ_BYTE0(bi ## _3))        \
      ^ SSH_RIJ_IL_TAB1(SSH_RIJ_BYTE1(bi ## _2))        \
      ^ SSH_RIJ_IL_TAB2(SSH_RIJ_BYTE2(bi ## _1))        \
      ^ SSH_RIJ_IL_TAB3(SSH_RIJ_BYTE3(bi ## _0))        \
      ^ k[3];                                           \
  }


#define SSH_RIJ_LS_BOX(x)               \
  (SSH_RIJ_FL_TAB0(SSH_RIJ_BYTE0(x))    \
   ^ SSH_RIJ_FL_TAB1(SSH_RIJ_BYTE1(x))  \
   ^ SSH_RIJ_FL_TAB2(SSH_RIJ_BYTE2(x))  \
   ^ SSH_RIJ_FL_TAB3(SSH_RIJ_BYTE3(x)))
...
#ifdef WIN32
/* The function below has been observed to compile into incorrect code
   if compiled with Visual C.  Since it is not the most-time critical
   function, we disable the optimizations in it for now. */
#pragma optimize ("", off)
#endif
                                  ...
                                  Boolean for_encryption)
{
  ...
  for (i = 0; i < key_words; i++)
    key_word[i] =
      (((SshUInt32) ((((i * 4) + 0) < keylen) ? key[(i * 4) + 0] : 0)) << 0) |
      (((SshUInt32) ((((i * 4) + 1) < keylen) ? key[(i * 4) + 1] : 0)) << 8) |
      (((SshUInt32) ((((i * 4) + 2) < keylen) ? key[(i * 4) + 2] : 0)) << 16) |
      (((SshUInt32) ((((i * 4) + 3) < keylen) ? key[(i * 4) + 3] : 0)) << 24);

  ctx->key[0] = key_word[0];
  ctx->key[1] = key_word[1];
  ctx->key[2] = key_word[2];
  ctx->key[3] = key_word[3];
  ...
  case 4:
    ...
    for (i = 0; i < 10; i++)
      {
        t = SSH_RIJ_LS_BOX(SSH_ROR32_CONST(t,  8)) ^ ssh_rij_rco_tab[i];
        t ^= ctx->key[4 * i];
        ctx->key[4 * i + 4] = t;
        t ^= ctx->key[4 * i + 1];
        ctx->key[4 * i + 5] = t;
  ...
  case 6:
    ctx->key[4] = key_word[4];
    t = ctx->key[5] = key_word[5];
    for (i = 0; i < 8; ++i)
      {
        t = SSH_RIJ_LS_BOX(SSH_ROR32_CONST(t,  8)) ^ ssh_rij_rco_tab[i];
        t ^= ctx->key[6 * i];
  ...
  case 8:
    ctx->key[4] = key_word[4];
    ctx->key[5] = key_word[5];
    ctx->key[6] = key_word[6];
    t = ctx->key[7] = key_word[7];
    for (i = 0; i < 7; ++i)
      {
        t = SSH_RIJ_LS_BOX(SSH_ROR32_CONST(t,  8)) ^ ssh_rij_rco_tab[i];
        t ^= ctx->key[8 * i];
        ...
        t ^= ctx->key[8 * i + 3];
        ctx->key[8 * i + 11] = t;
        t  = ctx->key[8 * i + 4] ^ SSH_RIJ_LS_BOX(t);
        ctx->key[8 * i + 12] = t;
        t ^= ctx->key[8 * i + 5];
        ctx->key[8 * i + 13] = t;
        t ^= ctx->key[8 * i + 6];
  ...
  if (ctx->for_encryption == FALSE)
    {
      for (i = 4; i < ((4 * key_words) + 24); i++)
        {
          u = (((ctx->key[i] & 0x7f7f7f7f) << 1) ^
               (((ctx->key[i] & 0x80808080) >> 7) * 0x1b));
          v = (((u & 0x7f7f7f7f) << 1) ^
               (((u & 0x80808080) >> 7) * 0x1b));
          w = (((v & 0x7f7f7f7f) << 1) ^
               (((v & 0x80808080) >> 7) * 0x1b));
          ...
          ctx->key[i] =
            u ^ v ^ w ^
            SSH_ROR32_CONST(u ^ t,  8) ^
            SSH_ROR32_CONST(v ^ t, 16) ^
            SSH_ROR32_CONST(t, 24);
        }
    }
...
static void ssh_rijndael_encrypt(const SshUInt32 blk_i[4],
                                 SshUInt32 blk_o[4],
                                 SshRijndaelContext ctx)

{



  SshUInt32 b0_0, b0_1, b0_2, b0_3, b1_0, b1_1, b1_2, b1_3, *kp;

  b0_0 = blk_i[0] ^ ctx->key[0];
  b0_1 = blk_i[1] ^ ctx->key[1];
  b0_2 = blk_i[2] ^ ctx->key[2];
  b0_3 = blk_i[3] ^ ctx->key[3];

  kp = ctx->key + 4;

#if SSH_INSN_CACHE_SIZE <= 8
  /* Don't unroll the loops if we have a smallish insn cache. */
  {
    int n_f_rounds = 4;
    if (ctx->key_len > 16)
      {
    ...
    goto f_rounds;
    do {
      SSH_RIJ_F_NROUND(b0, b1, kp);
    f_rounds:
      SSH_RIJ_F_NROUND(b1, b0, kp);
    } while (n_f_rounds-- > 0);
  }
#else
  if (ctx->key_len > 16)
...
static void ssh_rijndael_decrypt(const SshUInt32 blk_i[4],
                                 SshUInt32 blk_o[4],
                                 SshRijndaelContext ctx)

{
  ...
  b0_0 = blk_i[0] ^ ctx->key[ctx->key_len + 24];
  b0_1 = blk_i[1] ^ ctx->key[ctx->key_len + 25];
  b0_2 = blk_i[2] ^ ctx->key[ctx->key_len + 26];
  b0_3 = blk_i[3] ^ ctx->key[ctx->key_len + 27];

  kp = ctx->key + ctx->key_len + 20;
...
#if SSH_INSN_CACHE_SIZE <= 8
  {
    ...
    goto i_rounds;
    do {
      SSH_RIJ_I_NROUND(b0, b1, kp);
    i_rounds:
      SSH_RIJ_I_NROUND(b1, b0, kp);
    } while (n_i_rounds-- > 0);
  }
#else
  if (ctx->key_len > 16)
                      ...
                      unsigned char *iv_arg)
{
  ...
  if (ctx->for_encryption)
      ...
      while (len > 0)
        {
          ...
          ssh_rijndael_encrypt(iv, iv, ctx);
  ...
  else
    {
      ...
      /* The purpose of these memsets is to prevent leakage of iv's to
         someone else after a core. */
      memset(v, 0, sizeof(v));
    }
...
SshCryptoStatus ssh_rijndael_cbc(void *context, unsigned char *dest,
				 ...
				 unsigned char *iv_arg)
{
  /* This is apparently the most frequent use of this encryption
     algorithm.  Therefore we've manually inlined the calls to
     `ssh_rijndael_encrypt' and `ssh_rijndael_decrypt' in the
     innermost loop whenever we have a machine with a sufficiently
     large insn cache. */
  SshRijndaelContext ctx = (SshRijndaelContext) context;
  SshUInt32 b0_0, b0_1, b0_2, b0_3, b1_0, b1_1, b1_2, b1_3, *kp;
  SshUInt32 iv_0, iv_1, iv_2, iv_3;

  if (ctx->for_encryption)
    {
      iv_0 = SSH_GET_32BIT_LSB_FIRST(iv_arg);
      iv_1 = SSH_GET_32BIT_LSB_FIRST(iv_arg + 4);
      iv_2 = SSH_GET_32BIT_LSB_FIRST(iv_arg + 8);
      iv_3 = SSH_GET_32BIT_LSB_FIRST(iv_arg + 12);

      while (len > 0)
        {
          iv_0 ^= SSH_GET_32BIT_LSB_FIRST(src);
          iv_1 ^= SSH_GET_32BIT_LSB_FIRST(src + 4);
          iv_2 ^= SSH_GET_32BIT_LSB_FIRST(src + 8);
          iv_3 ^= SSH_GET_32BIT_LSB_FIRST(src + 12);
          ...
          if (ctx->key_len > 16)
            {
              if (ctx->key_len > 24)
                {
                  SSH_RIJ_F_NROUND(b1, iv, kp);
                  SSH_RIJ_F_NROUND(iv, b1, kp);
                }
              SSH_RIJ_F_NROUND(b1, iv, kp);
              SSH_RIJ_F_NROUND(iv, b1, kp);
            }
          ...
          SSH_RIJ_F_NROUND(iv, b1, kp);
          SSH_RIJ_F_NROUND(b1, iv, kp);
          SSH_RIJ_F_LROUND(iv, b1, kp);

          SSH_PUT_32BIT_LSB_FIRST(dest, iv_0);
          SSH_PUT_32BIT_LSB_FIRST(dest + 4, iv_1);
          SSH_PUT_32BIT_LSB_FIRST(dest + 8, iv_2);
          SSH_PUT_32BIT_LSB_FIRST(dest + 12, iv_3);

          src += 16;
          dest += 16;
          len -= 16;
        }
      SSH_PUT_32BIT_LSB_FIRST(iv_arg, iv_0);
      SSH_PUT_32BIT_LSB_FIRST(iv_arg + 4, iv_1);
      SSH_PUT_32BIT_LSB_FIRST(iv_arg + 8, iv_2);
      SSH_PUT_32BIT_LSB_FIRST(iv_arg + 12, iv_3);
    }
  else
    {
      SshUInt32 v_0, v_1, v_2, v_3, c_0, c_1, c_2, c_3;
      ...
      while (len > 0)
        {
          ...
          c_0 = SSH_GET_32BIT_LSB_FIRST(src);
          c_1 = SSH_GET_32BIT_LSB_FIRST(src + 4);
          c_2 = SSH_GET_32BIT_LSB_FIRST(src + 8);
          c_3 = SSH_GET_32BIT_LSB_FIRST(src + 12);

          b0_0 = c_0 ^ ctx->key[ctx->key_len + 24];
          b0_1 = c_1 ^ ctx->key[ctx->key_len + 25];
          b0_2 = c_2 ^ ctx->key[ctx->key_len + 26];
          b0_3 = c_3 ^ ctx->key[ctx->key_len + 27];
          ...
          SSH_PUT_32BIT_LSB_FIRST(dest, v_0);
          SSH_PUT_32BIT_LSB_FIRST(dest + 4, v_1);
          SSH_PUT_32BIT_LSB_FIRST(dest + 8, v_2);
          SSH_PUT_32BIT_LSB_FIRST(dest + 12, v_3);
      ...
      /* The purpose of these assignments is to prevent leakage of
         iv's to someone else after a core. */
      v_0 = v_1 = v_2 = v_3 = 0;
    }

  /* The purpose of these assignments is to prevent leakage of iv's to
     someone else after a core. */
  iv_0 = iv_1 = iv_2 = iv_3 = 0;
  return SSH_CRYPTO_OK;
}

#endif /* SSH_INSN_CACHE_SIZE > 8 */
