.set workspace_name sshcrypto
.set guid_t-proxykey 9D669ABE-115B-3575-9900-58F20FF2F96A
.set file_t-proxykey tests\\t-proxykey.vcproj
...
.set file_t-combined-modes tests\\t-combined-modes.vcproj
...
.set file_t-pkcs1implicit tests\\t-pkcs1implicit.vcproj
...
.set file_t-namelist tests\\t-namelist.vcproj
...
.set file_t-modetest tests\\t-modetest.vcproj
...
.set file_t-gentest tests\\t-gentest.vcproj
...
.set file_t-hdt tests\\t-hdt.vcproj
...
.set file_t-combined-speed tests\\t-combined-speed.vcproj
...
.set file_t-cipher-vs-mac-speed tests\\t-cipher-vs-mac-speed.vcproj
...
.set file_t-cryptest tests\\t-cryptest.vcproj
...
.set file_t-random tests\\t-random.vcproj
...
.set file_sshcipher sshcipher\\sshcipher.vcproj
...
.set file_sshhash sshhash\\sshhash.vcproj
...
.set file_sshrandom sshrandom\\sshrandom.vcproj
...
.set file_sshcryptocore sshcryptocore\\sshcryptocore.vcproj
