...
.set file_t-ikev2 t-ikev2.vcproj
...
.set file_t-fb-util t-fb-util.vcproj
...
.set file_t-multiauth t-multiauth.vcproj
...
.set file_t-ts-util t-ts-util.vcproj
...
.set file_ikev2-perftool ikev2-perftool.vcproj
