...
#ifndef SAFENET_PE_PEC_1746_PARAMS_H
#define SAFENET_PE_PEC_1746_PARAMS_H
...
/* This setting must be less or equal than 
   ADAPTER_EIP94V2_RINGSIZE_BYTES/(ADAPTER_EIP94V2_DESCRIPTORSPACING_WORDS * 4)
   used in the cs_adapter.h file of the 1746_V-Driver */
...
#endif /* SAFENET_PE_PEC_1746_PARAMS_H */
