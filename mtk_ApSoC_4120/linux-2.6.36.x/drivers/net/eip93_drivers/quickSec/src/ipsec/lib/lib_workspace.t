...
.set file_t-id sshisakmp\\tests\\t-id.vcproj
...
.set file_t-da sshisakmp\\tests\\t-da.vcproj
...
.set file_sshisakmp sshisakmp\\sshisakmp.vcproj
...
.set file_t-ikev2 sshikev2\\tests\\t-ikev2.vcproj
...
.set file_t-fb-util sshikev2\\tests\\t-fb-util.vcproj
...
.set file_t-multiauth sshikev2\\tests\\t-multiauth.vcproj
...
.set file_t-ts-util sshikev2\\tests\\t-ts-util.vcproj
...
.set file_ikev2-perftool sshikev2\\tests\\ikev2-perftool.vcproj
...
.set file_sshikev2 sshikev2\\sshikev2.vcproj
...
.set file_t-mschap sshppp\\tests\\t-mschap.vcproj
...
.set file_t-l2tp-seq sshl2tp\\tests\\t-l2tp-seq.vcproj
...
.set file_t-l2tp sshl2tp\\tests\\t-l2tp.vcproj
