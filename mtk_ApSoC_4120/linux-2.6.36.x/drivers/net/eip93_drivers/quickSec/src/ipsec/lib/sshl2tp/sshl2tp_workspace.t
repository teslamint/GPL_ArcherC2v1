.set workspace_name sshl2tp
.set guid_ssh-l2tp 04686A5F-FC2F-3648-9300-BB1A051CD204
.set file_ssh-l2tp tests\\ssh-l2tp.vcproj
...
.set file_t-l2tp-seq tests\\t-l2tp-seq.vcproj
...
.set file_t-l2tp tests\\t-l2tp.vcproj
...
.set file_sshl2tp sshl2tp.vcproj
