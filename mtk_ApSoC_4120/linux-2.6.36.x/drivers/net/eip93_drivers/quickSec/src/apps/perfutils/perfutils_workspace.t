.set workspace_name perfutils
.set guid_udp-send A966F6A6-1D3F-30D2-8500-BFFC56E80BF4
.set file_udp-send udp-send.vcproj
...
.set file_udp-recv udp-recv.vcproj
...
.set file_ubenchmark ubenchmark.vcproj
...
.set file_ubenchmark-multiport ubenchmark-multiport.vcproj
...
.set file_tbenchmark tbenchmark.vcproj
