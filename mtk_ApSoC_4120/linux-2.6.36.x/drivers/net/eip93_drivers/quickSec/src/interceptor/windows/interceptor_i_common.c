                            ...
                            void *init_fn_context)
{
  ...
  ssh_log_event(SSH_LOGFACILITY_LOCAL0, 
                SSH_LOG_NOTICE, ("Loading Authentec QuickSec driver"));
                               ...
                               void *start_fn_context)
{
  ...
  ssh_log_event(SSH_LOGFACILITY_LOCAL0, 
                SSH_LOG_NOTICE,
                ("Authentec QuickSec driver up and running"));
 ...
 failed:
  ...
  ssh_log_event(SSH_LOGFACILITY_LOCAL0, 
                SSH_LOG_CRITICAL,
                ("Failed to start Authentec QuickSec driver!")); 
                              ...
                              void *uninit_fn_context)
{
  ...
  ssh_log_event(SSH_LOGFACILITY_LOCAL0, 
                SSH_LOG_NOTICE,
                ("Authentec QuickSec driver unloaded"));
...
ssh_interceptor_get_os_version(void)
{
  ...
  os_version = (0x10000 | ((osvi.dwMajorVersion << 4) | osvi.dwMinorVersion));
