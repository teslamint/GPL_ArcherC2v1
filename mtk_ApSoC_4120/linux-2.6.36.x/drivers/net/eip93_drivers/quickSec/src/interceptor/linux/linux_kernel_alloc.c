/**
   ...
   Implementations of the kernel allocation API defined in
   engine/kernel_alloc.h for Linux platforms.
...
#define SSH_DEBUG_MODULE "SshLinuxKernelAlloc"
...
{
  /* Placeholder for possible future module initialization tasks. */
  return TRUE;
}
