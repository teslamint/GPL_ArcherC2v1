 ...
 * history 	\arg	
 */
#ifndef __RTL8367_API_H__
#define __RTL8367_API_H__
...
#define EXT1_RGMXF		0x1307
#define EXT2_RGMXF		0x13c5
#define RGMXF_CONF		0x8
...
struct rtl8367IpMcastRule
{
	rtk_mac_t mac;
	rtk_uint32 ip_addr;
};

typedef enum ipMcastRuleType
{
    PORT_ADD = 0,
    PORT_DEL,
    PORT_END
