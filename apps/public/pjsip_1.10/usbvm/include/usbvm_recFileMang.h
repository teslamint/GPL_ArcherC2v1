...
#define USB_INDEX_FILE_DIR USB_VOICEMAIL_DIR"/index/endpt"            /* record index file directory */
#define USB_REC_FILE_DIR USB_VOICEMAIL_DIR"/record/endpt"             /* record file directory */
#define USB_WAV_FILE_DIR USB_VOICEMAIL_DIR"/wav/"                     /* wav file directory */
#define USB_NOT_FILE_CUSTOM_DIR USB_VOICEMAIL_DIR"/voiceNotify/endpt" /* custom voice notify directory */
#define USB_NOT_FILE_DEF_DIR USB_VOICEMAIL_DIR"/voiceNotify/"         /* default voice notify directory */

/* Now we only support PCMU in local playing */

#define USB_NOT_NO_REC_FILE "noRecordNotify_g711u"
#define USB_NOT_NO_NEW_REC_FILE "noRecordNotify_g711u"
/* 
