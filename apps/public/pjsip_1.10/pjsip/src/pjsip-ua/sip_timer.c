/* $Id: sip_timer.c 3553 2011-05-05 06:14:19Z nanang $ */
/* 
...
pj_status_t pjsip_timer_init_session(
					...
					, int refresher/*Telefonica. By YuChuwei*/
#endif
					)
{
...
#ifdef INCLUDE_TFC_ES
	/*Telefonica. By YuChuwei*/
	inv->timer->refresher = refresher;
...
pj_status_t pjsip_timer_process_req(pjsip_inv_session *inv,
					    ...
					    pjsip_status_code *st_code
#ifdef INCLUDE_TFC_ES
						,pj_bool_t isReInvite /*By yuchuwei, For Telefonica*/
#endif
					    )
{
    pjsip_min_se_hdr *min_se_hdr;
