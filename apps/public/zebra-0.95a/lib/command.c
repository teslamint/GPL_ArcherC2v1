...
#if defined(TP_CMD_SUPPORT) && defined(HAVE_IPV6)
...
#endif /* TP_CMD_SUPPORT and HAVE_IPV6 */
...
#if defined(TP_CMD_SUPPORT) && defined(TP_RIP_DEBUG)
...
#endif /* CMD_SUPPORT and RIP_DEBUG */
